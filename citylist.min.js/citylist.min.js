...
function selectState(){let selectedState=document.getElementById("stateSelector").value;document.getElementById("displayState").textContent=selectedState;let cityNodeCheck=document.getElementById("citySelector");if(cityNodeCheck.childElementCount>1){cityNodeCheck.length=0;let opt=document.createElement("option");opt.value="default";opt.selected=!0;opt.disabled=!0;opt.textContent="Select City";cityNodeCheck.appendChild(opt);document.getElementById("displayCity").textContent=null}
